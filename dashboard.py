...
#--------------------------- Client Informations --------------------------
def display_client_info(id_client, revenu_client, age_client, jours_employe):
    st.subheader("Informations sur le client")
    st.write("ID du Client:", id_client)
    st.write("Revenu du Client:", revenu_client)
    st.write("Âge du Client:", age_client)
    st.write("Jours employé:", jours_employe)
...
def show_client_predection():
    ...
    #selected_client_id = st.selectbox("Sélectionnez un client par son ID", client_ids)
    selected_client_id = int(st.selectbox("Sélectionnez un client par son ID", client_ids))
